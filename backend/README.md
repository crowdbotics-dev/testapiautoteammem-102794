...
## Project Structure
    ...
    ├── testapiautoteammem_102794  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_102794`
...
2. Clone this repo and `cd testapiautoteammem_102794`
